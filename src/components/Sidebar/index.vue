<template>
  <div class="has-logo">
    ...
    <el-menu :default-active="activeMenu" :collapse="true" :collapse-transition="false" :unique-opened="true"
      active-text-color="#409EFF" background-color="#304156" text-color="#bfcbd9" mode="vertical">
